...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            <section class="row">
                <a href="#create-portalEmail" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
            ...
            <section class="row">
                <div id="create-portalEmail" class="col-12 content scaffold-create" role="main">
                    ...
                    <g:form useToken="true" resource="${this.portalEmail}" method="POST">
                        <fieldset class="form">
