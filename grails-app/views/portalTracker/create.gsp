            ...
            <section class="row">
                <div id="create-portalTracker" class="col-12 content scaffold-create" role="main">
                    ...
                    <g:form useToken="true" resource="${this.portalTracker}" method="POST">
                        <fieldset class="form">
                            <f:all except='postprocess,datas,listfields,filterfields,initial_status,excelfields,allowadd,downloadexcel,excel_audit,defaultsort,tickactions,actionbuttons,searchfields,row_validation_fields,defaultfield,anonymous_list,anonymous_view,require_login,condition_q,rowclassval,fields,statuses,roles,transitions,emails,flows,indexes' bean="portalTracker"/>
                        </fieldset>
