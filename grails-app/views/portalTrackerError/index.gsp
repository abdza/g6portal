...
<html>
  ...
  td:nth-of-type(13):before { content: "Ip Addr"; }
    ...
    <div id="content" role="main">
        <div class="container">
            <section class="row">
                <a href="#list-portalTrackerError" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
            ...
            <section class="row">
                <div id="list-portalTrackerError" class="col-12 content scaffold-list" role="main">
			...
			<fieldset class='form'>
                    ...
                    <f:table collection="${portalTrackerErrorList}" except="params" />

                    <g:if test="${portalTrackerErrorCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${portalTrackerErrorCount ?: 0}" params="${params}"/>
                    </div>
                    </g:if>
                </div>
            </section>
