        ...
        <div class="container">
            ...
            <section class="row">
                <div id="show-portalTrackerFlow" class="col-12 content scaffold-show" role="main">
                    ...
                    <f:display bean="portalTrackerFlow" />
                    <g:form resource="${this.portalTrackerFlow}" method="DELETE">
                        <fieldset class="buttons">
                            <g:link class="edit" action="edit" resource="${this.portalTrackerFlow}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                            <g:link class="edit" action="details" resource="${this.portalTrackerFlow}">Details</g:link>
